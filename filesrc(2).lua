...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>KhongTenBloxFruit chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "KhongTenBloxFruit", HidePremium = false, IntroText = "KhongTenBloxFruit⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "KhongTenBloxFruit",
...
W:AddLabel("KhongTenBloxFruit SCRIPT")
W:AddLabel("DiscordKhongTenBloxFruit")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "KhongTenBloxFruit(Noitification)",
